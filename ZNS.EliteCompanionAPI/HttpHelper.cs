...
namespace ZNS.EliteCompanionAPI
{
    internal class HttpHelper
    {
        ...
        public async Task<HttpWebResponse> Get(string url, NameValueCollection query)
        {
        ...
        public async Task<HttpWebResponse> Post(string url, NameValueCollection data = null, bool urlAsReferrer = false)
        {
            var request = GetRequest(url);
            request.Method = "POST";
